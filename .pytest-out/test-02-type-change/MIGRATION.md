...
|---|---|---|---|---|---|---|
| `order_details` | dataset | 1 | **BREAKING** | 70 | column-level lineage edge from orders.order_total | add_contract_test |
...
| `ORDER_DETAILS` | dataset | 2 | **RISKY** | 42 | column-level lineage edge from orders.order_total | add_contract_test |
| `order_details` | dataset | 3 | **RISKY** | 39 | column-level lineage edge from orders.order_total | add_contract_test |
| `ORDER_DETAILS` | dataset | 3 | **RISKY** | 39 | column-level lineage edge from orders.order_total | add_contract_test |
