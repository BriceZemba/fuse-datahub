...
timing: lineage took 42.2s
impact: 17 asset(s) — 1 breaking, 16 risky, 0 safe
timing: impact took 0.0s
plan: LLM planning failed (JSONDecodeError), using rules
timing: plan took 134.5s
codegen: 3 artifact(s) (attempt 1)
timing: codegen took 13.9s
