# Migration plan - drop_column customers.credit_limit
...
- **Model:** `customers` (`models/marts/customers.sql`)
...
| `order_details` | dataset | 1 | **RISKY** | 35 | reads from customers; no column-level proof either way | add_compat_view |
